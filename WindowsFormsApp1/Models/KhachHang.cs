...
namespace WindowsFormsApp1.Models
{
    class KhachHang
    {
        ...
        {
            return int.Parse(Models.Connection.ExcuteScalar("select dbo.CheckCustomerinDay(" + User.getUser().pbranch + "," + mkh + ")"));
        }
        ...
        {
            string sql = "exec FindInfor N'" + st + "',"+User.getUser().pbranch;
